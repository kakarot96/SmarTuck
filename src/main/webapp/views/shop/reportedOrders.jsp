...
<%
	List<List<Order>> shopOrders = (List<List<Order>>) request.getAttribute("reportedOrders");
		String openComment = " ";
		String closeComment = " ";	
...
<c:forEach var="listValue" items="${reportedOrders}">
	<%
            ...
            <div class="col-xs-12 col-md-12 align-left">
                <div class="timeline-text-content">
                    <h4 class="mbr-timeline-title pb-3 mbr-fonts-style display-5">
                        ORDER <%=orderNum++ %>
                        <div class="mbr-section-btn align-right"><a class="btn btn-warning display-4" href="/shop/unreportOrder?id=${id}&orderId=${listValue.get(0).getOrderId()}">UN-REPORT</a></div>
                    </h4>
